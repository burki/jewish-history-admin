  ...
  function instantiateUploadRecord (&$dbconn) {
    ...
    $img_record->add_fields(
      array(
        ...
        new Field(array('name'=>'item_id', 'type'=>'hidden', 'datatype'=>'int', 'null'=>1)),
        ...
        new Field(array('name'=>'width', 'type'=>'hidden', 'datatype'=>'int', 'null'=>1)),
        new Field(array('name'=>'height', 'type'=>'text', 'datatype'=>'int', 'null'=>1)),
        new Field(array('name'=>'name', 'type'=>'hidden', 'datatype'=>'char', 'null'=>1)),
        new Field(array('name'=>'mimetype', 'type'=>'hidden', 'datatype'=>'char', 'null'=>1)),
        new Field(array('name'=>'caption', 'type'=>'textarea', 'cols'=>60, 'rows'=>3, 'datatype'=>'char', 'null'=>1)),
        new Field(array('name'=>'copyright', 'type'=>'text', 'size'=>60, 'maxlength'=>255, 'datatype'=>'char', 'null'=>1)),
        new Field(array('name'=>'created', 'datatype'=>'function', 'value' => 'NOW()', 'noupdate' => 1))
      ));
    return $img_record;
  }
